...
module.exports = {
    ...
    async execute(interaction) {
        ...
        const sourceEmbed = new Discord.EmbedBuilder()
            .setAuthor({
        ...
        try {
            ...
            logger.loggerError(`Error moving thread ${sourceThread.name} to ${targetThread.name}:`, error);
